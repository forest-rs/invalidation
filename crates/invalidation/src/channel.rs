...
//! Channel and channel set types for identifying invalidation domains.
...
/// such as marking a node invalidated in several domains simultaneously.
///
/// # Example
///
/// ```
...
/// - [`InvalidationSet`](crate::InvalidationSet): Uses channels to partition invalidated keys.
